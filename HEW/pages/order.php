    ...
    <form action="confirm.php" method="post">
        ...
        <div id="page1">
            ...
            <div id="menu">
                ...
                <div class="foods">
                    ...
                    <div class="foodtext">
                        <p>冷たい飲み物<br>さらりとした飲み口</p>
                    </div>
                    <div class="foodprice">
                        <p>150円</p>
                    </div>
                    <p>
                        数量：<select name="drink">
                            <?php
                            for ($i = 0; $i <= 100; $i++) {
                            ?>
                                <option value="<?php echo $i; ?>"><?php echo $i; ?></option>
        ...
        <div id="page2">
            <div id="profile">
                ...
                <p>住所：<input type="text" name="adress" size="40"></p>
                <p>電話：<input type="text" name="phone" size="40"></p>
                <p id="submitbutton"><input type="submit" value="注文確認へ"></p>
            </div>
        </div>
